...
object WordnikServerGenerator extends BasicScalaGenerator {
  def main(args: Array[String]) = generateClient(args)

  override def templateDir = "src/main/templates/server"

  val outputFolder = "wordnik-server"
  ...
  override def supportingFiles = List(
    ...
    ("Utils.scala", destinationDir, "services/Utils.scala"),
        ...
        case "allParams" => {
          ...
          paramList.foreach(param => {
            ...
            if(map.contains("allowableValues")) {
              ...
              val pattern = "([A-Z]*)\\[(.*)\\]".r
              val str = allowableValues.asInstanceOf[Option[String]].getOrElse("") match {
